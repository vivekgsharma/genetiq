...
function AnimatedCarousel() {
  return (
    <div className="enter-genetiq-container">
      ...
      <div className="gentix-continer-track">
        <div className="gentix-continer-items">
          <div className="card-genitq-container">
            <div>
              <p>
                <span>GenetiQ</span> is a platform offering personalized drugs
                and custom supplements tailored to individuals' unique genomic
                profiles.
              </p>
            </div>
          ...
          <div className="card-genitq-container">
            <div>
              <p>
                <span>A pioneering contender</span> in medical wellbeing,
                GenetiQ combines innovative scientific advances with holistic
                wellness to provide a best treatments and wellness therapies in
                the world.
              </p>
            </div>
            <div className="card-genitq-imgWrapper">
